...
def train():
    ...
    train_dataset = DonutDataset(
        r"d:\data\HUIT\Nam3\HK2\Deep Learning\TaiLieuThayBao\Project\Donut\Version2\Train_data\train_metadata.jsonl", 
        processor, split="train"
    )
    val_dataset = DonutDataset(
        r"d:\data\HUIT\Nam3\HK2\Deep Learning\TaiLieuThayBao\Project\Donut\Version2\Train_data\val_metadata.jsonl", 
        processor, split="val"
    )
